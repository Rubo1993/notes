    ...
    <div class="user-index">
        ...
        $gridColumns = [
            ...
            [
                ...
                'value' => function ($data) {
//        var_dump($data);
                    return $data->profession == '0' ? '<span class="text-success">Stydent</span>' : '<span class="text-success">Profesor</span>';
                },
                'format' => 'html',
            ],
            [
                'attribute' => 'verify',
                'value' => function ($data) {
                    return $data->verify == '0' ? '<span class="text-success">Stydent</span>' : '<span class="text-' . ($data->profession == '0' ? 'danger' : 'success') . '">Profesor</span>';
                },
                'format' => 'html',
            ],
            [
