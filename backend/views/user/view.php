    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value'=>function($data){
                    return $data->profession == '0' ? '<span class="text-' . ($data->profession == '0' ? 'danger' : 'success') . '")>Stydent</span>' : '<span class="text-success">Profesor</span>';
                },
                'format'=>'html',
            ],
            [
                'attribute'=>'cash',
                'value'=>function($data){
                    return $data->cash == Null ? '<span class="text-success">0</span>' : $data->cash;
                },
                'format'=>'html',
            ],
            ...
            [
                'attribute'=>'verify',
                'value'=>function($data){
                    return $data->verify == '0' ? '<span class="text-success">Stydent</span>' : '<span class="text-success">Profesor</span>';
                },
                'format'=>'html',
            ],
            [
                ...
                'value' => function ($model) {
                    return Html::a('Download CV', '@site_url/'.$model->cv_url . $model->cv);
...
//            ],
            ...
            [
                'attribute' => 'image',
                'format' => 'raw',
                'value' => ($model->image)?'<img src="/'.$model->user_img_url.$model->image.'" class="thumbnail admin_user_imgs">':null,
